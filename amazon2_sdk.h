...
#define GetRedValue_RGB565(Color,r)	(r = (U8)(Color&0xf800)>>11)		//0xf800	=	1111 1000 0000 0000
#define GetGreenValue_RGB565(Color,g)	(g = (U8)(Color&0x07e0)>>5)		//0x07e0	=	0000 0111 1110 0000
#define GetBlueValue_RGB565(Color,b)	(b = (U8)Color&0x0001f)			//0x0001f	=	0000 0000 0001 1111

#define MIN(a,b)  ((a) > (b) ? (b) : (a))
#define MAX(a,b)  ((a) < (b) ? (b) : (a))

#define GetPtr(arr, row, column, width) (arr[((row)*(width)) + (column)]) 
//------------------------------------------------
...
typedef enum 
{
	...
	AMAZON2_IOCTL_CAM_DISP_STAT, //16
